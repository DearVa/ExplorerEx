...
[Guid(Shell32Interop.IID_IShellFolder)]
internal interface IShellFolder {
	...
	[PreserveSig]
	int ParseDisplayName(IntPtr hwnd, IntPtr pbc, string pszDisplayName, uint pchEaten, out IntPtr ppidl, uint pdwAttributes);
	...
	[PreserveSig]
	int EnumObjects(IntPtr hwnd, SHCONT grfFlags, out IEnumIDList ppenumIDList);
	...
	/// </param>
	[PreserveSig]
	int GetAttributesOf(uint cidl, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] IntPtr[] apidl, out SFGAO rgfInOut);
	...
	[PreserveSig]
	int GetUIObjectOf(IntPtr hwndOwner, uint cidl, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] IntPtr[] apidl, [In] ref Guid riid, uint rgfReserved, out IntPtr ppv);
	...
	[PreserveSig]
	int SetNameOf(IntPtr hwnd, IntPtr pidl, string pszName, SHGDN uFlags, out IntPtr ppidlOut);
}
...
[Guid(Shell32Interop.IID_IShellFolder2)]
internal interface IShellFolder2 : IShellFolder {
	...
	/// </returns>
	[PreserveSig]
	new int EnumObjects(IntPtr hwnd, SHCONT grfFlags, out IEnumIDList ppenumIDList);
	...
	/// <returns></returns>
	[PreserveSig]
	new int CompareIDs(int lParam, IntPtr pidl1, IntPtr pidl2);
	...
	/// </returns>
	[PreserveSig]
	new int GetAttributesOf(uint cidl, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 0)] IntPtr[] apidl, out SFGAO rgfInOut);
	...
	/// </returns>
	[PreserveSig]
	new int GetUIObjectOf(IntPtr hwndOwner, uint cidl, [MarshalAs(UnmanagedType.LPArray, SizeParamIndex = 1)] IntPtr[] apidl, [In] ref Guid riid, uint rgfReserved, out IntPtr ppv);
	...
	/// </returns>
	[PreserveSig]
	new int GetDisplayNameOf(IntPtr pidl, SHGDN uFlags, out StrRet pName);
	...
	/// </returns>
	[PreserveSig]
	new int SetNameOf(IntPtr hwnd, IntPtr pidl, string pszName, SHGDN uFlags, out IntPtr ppidlOut);
	...
	/// <returns>Returns S_OK if successful, or a COM error value otherwise.</returns>
	[PreserveSig]
	int GetDefaultColumnState(uint iColumn, ref IntPtr pcsFlags);
