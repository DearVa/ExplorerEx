...
[TemplatePart(Name = NonClientArea, Type = typeof(UIElement))]
public class Window : System.Windows.Window {
	#region fields

	private const string NonClientArea = "PART_NonClientArea";
	...
	public override void OnApplyTemplate() {
		...
		_nonClientArea = GetTemplateChild(NonClientArea) as UIElement;
	}
