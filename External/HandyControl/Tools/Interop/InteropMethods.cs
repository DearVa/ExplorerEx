...
namespace HandyControl.Tools.Interop {
	internal static class InteropMethods {
		...
		internal static extern void DwmEnableBlurBehindWindow(IntPtr hwnd, ref DwmBlurBehind blurBehind);
		...
		[DllImport(ExternDll.User32, PreserveSig = false)]
		public static extern void SetWindowCompositionAttribute(IntPtr hwnd, ref WindowCompositionAttributeData data);

		public static void EnableAcrylic(IntPtr hwnd) {
			var accent = new AccentPolicy {
				AccentState = AccentState.EnableAcrylicBlurBehind,
				// 20: 透明度 第一个0xFFFFFF：背景色
				GradientColor = (10 << 24) | (0xFFFFFF & 0xFFFFFF)
			};
		...
		public static extern long DwmSetWindowAttribute(IntPtr hwnd, DwmWindowAttribute attribute, ref DwmWindowCornerPreference pvAttribute, uint cbAttribute);
		#endregion
